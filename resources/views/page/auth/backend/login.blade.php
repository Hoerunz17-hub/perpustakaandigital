...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assetsbackend/compiled/svg/favicon.svg') }}" type="image/x-icon">
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html"><img src="{{ asset('assetsbackend/compiled/svg/logo.svg') }}"
                                alt="Logo"></a>
                    </div>
