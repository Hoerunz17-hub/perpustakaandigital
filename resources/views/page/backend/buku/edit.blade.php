                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="/buku/update/{{ $data->id_buku }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" id="judul_buku" class="form-control"
                                                    placeholder="judul_buku" name="judul_buku" data-parsley-required="true"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="stock" class="form-control" name="stock"
                                                    data-parsley-required="true" / value="{{ $data->stock }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="tahun_terbit" class="form-control"
                                                    ...
                                                    data-parsley-required="true" / value="{{ $data->tahun_terbit }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="deskripsi_buku" class="form-label">Deskripsi
                                                    Buku</label>
                                                <textarea class="form-control" id="deskripsi_buku" rows="2" name="deskripsi_buku" placeholder="Deskripsi Buku">{{ $data->deskripsi_buku }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                @if ($data->cover)
                                                    <img src="{{ asset('storage/' . $data->cover) }}" width="80">
                                                @endif
